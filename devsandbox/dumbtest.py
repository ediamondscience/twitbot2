...
'''
s=set(' ¿Cuál es el link de la tienda en línea?')
cs=set(' abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789,.:;<>/?`~!@#$%^&*()-=_+[]{}"'+"\\ \n'")
print(s)
print(s.difference(cs))
'''

print('http' in ('https://t.co/bPaCHgsw2J'))
